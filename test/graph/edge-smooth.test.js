...
import { smoothLevers, smoothPorts } from '../../src/graph/edge-smooth';
import { portStubs } from '../../src/graph/edge-spline';
...
describe( 'smoothLevers', () => {
	...
	it( 'tracks a drag exactly — the lever rides the stubs', () => {
		...
		// The card moves a little; the lever keeps its place relative to
