 ...
 * `GraphEdgeOverlay` the head itself, `GraphEdgeAnchors` the ring that grabs
 * it — and a ring that drifted off the mark it grabs would be a control
 * pointing at nothing.
 *
 ...
 * nodes is nearly always a port that should have been on the other border:
