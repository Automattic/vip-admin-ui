 ...
 * between the two node centers crosses that node's border. A node below its
 ...
 *
 * Ports are then eased off the corners: chosen by the centre ray, two nodes
 ...
 * not that: two nodes dropped on the same spot are two valid rectangles in a
