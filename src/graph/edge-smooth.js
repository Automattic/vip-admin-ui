 ...
 *
 * A port doesn't drift — it either follows its node continuously, or it
 ...
 * node moves out from under it, and a fast drag tears the end of the edge off
 ...
 * node is being dragged tracks 1:1 — the lever travels with the stubs — and
