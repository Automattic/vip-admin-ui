...
export function bundleEdges( plans, sticky = null, relane = false ) {
	...
	looms.forEach( ( group ) => {
		...
		// `spreadPorts` precisely so the short run between two close nodes
...
/**
 * Nodes push bundles aside, not individual threads.
 *
 ...
 * counts toward it. It is short, it runs between its own two nodes, and a
